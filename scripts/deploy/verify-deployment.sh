...
function compute_services {
  ...
  SYSTEMD_LINKS+=( email-failures@.service nginx.service.d apache2.service.d cloud_vision_ocr@.service minion@$SERVICE.service )
  # units that must be active (and enabled)
  SYSTEMD_UNITS_ACTIVE=( nginx.service apache2.service cloud_vision_ocr@$SERVICE.service minion@$SERVICE.service )
