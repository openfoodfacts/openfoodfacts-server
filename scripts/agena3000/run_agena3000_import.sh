...
/srv/off-pro/scripts/convert_gs1_json_to_off_csv.pl --input-dir /srv2/off-pro/agena3000-data-tmp --output /srv2/off-pro/agena3000-data-tmp/agena3000-data.tsv
