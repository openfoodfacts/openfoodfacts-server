...
use ProductOpener::Lang qw/$lang $lc %lang_lc lang/;
	...
	while (my $product_ref = $cursor->next) {
			...
			and ($sc > 1))
		{
			...
			$html
				.= "<tr><td>"
				. $product_ref->{code}
				. "</td><td><a href=\"https://combiendesucres.fr/$id\">"
			...
			my $description
				= "Combien de sucre y a-t-il dans $name ? Devinez quel est l'équivalent en morceaux de sucres avec notre jeu instructif, simple et rapide.";
