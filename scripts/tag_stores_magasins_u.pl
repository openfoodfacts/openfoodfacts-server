...
use ProductOpener::Tags qw/%tags_fields %taxonomy_fields canonicalize_taxonomy_tag get_taxonomyid/;
...
my $csv_file = "/srv2/off/imports/systemeu/data/SUYQD_DISPOMAG.csv";
