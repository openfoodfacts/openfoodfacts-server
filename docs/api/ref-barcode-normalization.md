...
* EAN-13 / GTIN-13: 13 digits barcode
* EAN-8: 8 digits barcode, short version of EAN-13 barcodes that have 5 leading 0s
* UPC-A / UPC-12: 12 digits barcode that were used mostly in the US and Canada. A leading 0 can be added to get the corresponding EAN-13.
* UPC-E: 7 digits barcode, short version of UPC-A
...
### Barcode normalisation and checks in the SDKs
* Some of the Open Food Facts SDKs provide easy utils to deal with that.
