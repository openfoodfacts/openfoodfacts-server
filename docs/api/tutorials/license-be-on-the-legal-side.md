...
* Please read the [API FAQ](https://world.openfoodfacts.org/faq#api-data-reuse), which includes legal questions as well. If your question is not answered, please send it to [reuse@openfoodfacts.org](mailto:reuse@openfoodfacts.org)
