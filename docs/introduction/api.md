...
- [OpenAPI documentation (v2)](../reference/api.md)
- [OpenAPI documentation for v3](../reference/api-v3.md) (for packaging components only)
- A [cheatsheet](../reference/api-cheatsheet.md) to remind some usual patterns.

## Tutorials

- A comprehensive introduction to [Using the Open Food Facts API](../tutorials/using-the-OFF-API-tutorial.md).
