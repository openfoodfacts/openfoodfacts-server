...
foreach my $group_ref (@$select2_options_ref) {
	...
	foreach my $field_ref (@{$group_ref->{children}}) {
		...
		my $example_row = [
			...
			"",
			"",
			"wheat flour 65%, water, sugar, rapeseed oil, salt, vinegar, yeast, flour of beans, wheat gluten, flavor (contains alcohol), extract of acerola, may contain traces of eggs, soya, milk, fruit shell, sesame seeds",
			"Gluten",
			"Eggs, Milk, Nuts, Sesame seeds, Soybeans",
			"1172",
			"271",
			"4.1",
			"0.4",
			...
			"",
			"",
			"https://drive.google.com/file/d/1N6K0GOy8ZrO21732XF1M6klhRrzyAaaP/view?usp=sharing",
			"https://drive.google.com/file/d/14181RIHe89KN2aPzT3C2NQYqFZficOwE/view?usp=drive_link",
			"https://drive.google.com/file/d/1e8sW-Xp5QXc41V5ry-hLn8T8s13fvS38/view?usp=sharing",
		];
