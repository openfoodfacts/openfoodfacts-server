...
my @expected_headers = (
    "EAN", "Nom", "Marque", "Catégorie", "Boisson",
    "Label 1", "Label 2",
    "Ingrédient", "Origine", "Pourcentage",
    "Ingrédient - 2", "Origine - 2", "Pourcentage - 2",
    "Ingrédient - 3", "Origine - 3", "Pourcentage - 3",
    "Ingrédient - 4", "Origine - 4", "Pourcentage - 4",
    "Ingrédient - 5", "Origine - 5", "Pourcentage - 5",
    "Ingrédient - 6", "Origine - 6", "Pourcentage - 6",
    "Format", "Matériau",
    "Format - 2", "Matériau - 2",
    "Format - 3", "Matériau - 3",
    "Huile de palme", "Poissons menacés"
);
