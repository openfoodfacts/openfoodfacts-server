...
This directory contains the automated scripts (agents) responsible for synchronizing food traceability and packaging codes from official national and international registries into the Open Food Facts database.
