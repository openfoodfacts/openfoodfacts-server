...
(function( $ ){
    ...
    show : function( ) {
      ...
      var svg = document.querySelector('#imgsearchbutton_block_side svg.icon');
			html += '<a href="#" class="button small expand" id="imgsearchbutton_' + id + '"> ' + svg.outerHTML + Lang.upload_image
