...
INTEGRATION_GROUP_3_TESTS := api_cgi_nutrients.t api_v3_product_services_external.t convert_and_import_excel_file.t facets.t product_read.t web_html.t
INTEGRATION_GROUP_4_TESTS := api_cgi_suggest.t api_v3_product_write.t cors.t fix_non_normalized_codes.t protected_images.t
INTEGRATION_GROUP_5_TESTS := api_v2_product_read.t api_v3_product_write_nutrition.t countries.t import_csv_file.t protected_product.t
INTEGRATION_GROUP_6_TESTS := api_v2_product_write.t api_v3_taxonomy.t create_pro_user.t import_systemeu.t recipes_stats.t
