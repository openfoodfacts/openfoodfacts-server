...
# Load the wikidata-query-export.json file generated by https://query.wikidata.org/
with open('wikidata-query-export.json', 'r') as f:
...
with open('categories.wip.txt', 'r') as f:
...
with open('categories.wip.txt', 'w') as f:
