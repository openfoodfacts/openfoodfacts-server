...
is(convert_to_standard_unit("kg"), "g");
is(convert_to_standard_unit("g"), "g");
is(convert_to_standard_unit("l"), "ml");
is(convert_to_standard_unit("fl oz"), "ml");
is(convert_to_standard_unit("ml"), "ml");
is(convert_to_standard_unit("kcal"), "kj");
is(convert_to_standard_unit("kj"), "kj");
is(convert_to_standard_unit("mmol/l"), "mmol/l");
is(convert_to_standard_unit("ppm"), "mmol/l");
