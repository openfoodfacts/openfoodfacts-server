...
sub do_mock() {
    ...
    my %fake_content = (
        '42' => '{"title": {"rendered": "Contribute to the project"}, "content": {"rendered": "<h1>Contribute</h1>"}, "slug": "contribute"}',
        '45' => '{"title": {"rendered": "Découvrez le projet"}, "content": {"rendered": "<h1>Découvrir</h1>"}, "slug": "découvrir"}',
    );
    my $fake_nodes = '[
        {
            "databaseId": 42,
    ...
    my $mocked_http_tiny = mock 'HTTP::Tiny' => (
        override => [
            ...
            'get' => sub {
                ...
                return {success => 1, content => $fake_content{$page_id} // []};
            },
        ],
    );
...

{
    ...
    $result = wp_get_page_from_slug("fr", encode_utf8("découvrir"));
