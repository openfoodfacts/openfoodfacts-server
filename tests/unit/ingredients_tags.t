...
my @tests = (
	...
	[
		{lc => "fr", ingredients_text => "arôme naturel de pomme avec d'autres arômes naturels"},
		["en:natural-apple-flavouring", "en:natural-flavouring"],
	],
	[
		{
			lc => "fr",
	...
	[
		{lc => "fr", ingredients_text => "100 % semoule de BLE dur de qualité supérieure, Traces de moutarde"},
	...
	[
		{lc => "fr", ingredients_text => "Céleri - rave, choux - fleurs, béta - carotène"},
		["en:celeriac", "en:cauliflower", "en:e160ai"],
	],
	...
	[
		{
			lc => "fr",
			ingredients_text =>
				"Farine de blé 60%. Les pourcentages sont exprimés sur le produit avant cuisson. Sucre 40% (% exprimé sur la pâte)"
		},
	...
	[
		{
			lc => "fr",
			ingredients_text =>
				"émincé de filet de poulet traité en salaison cuit rôti, Pourcentages exprimés sur les pâtes alimentaires aux oeufs "
		},
	...
	[{lc => "fr", ingredients_text => "graisse végétale bio (colza)"}, ["en:vegetable-oil", "en:colza-oil"]],
	...
	[{lc => "en", ingredients_text => "vegetable oil (coconut & rapeseed)"}, ["en:vegetable-oil", "en:coconut-oil", "en:rapeseed-oil"]],
	...
	[
		{
			lc => "fr",
			ingredients_text => "Fraises. Contient du lait et des noix. Peut contenir : crustacés, céleri et moutarde."
		},
		["en:strawberry"]
	],
	[
	...
	[
		{
			lc => "en",
			ingredients_text =>
				"salt, spice. allergy advice: for allergens, see ingredients in bold. May contain traces of nuts."
		},
		['en:salt', 'en:spice']
	],
	[
		{
			lc => "en",
			ingredients_text =>
				"salt, spice. allergen advice: for allergens including cereals containing gluten, see ingredients in bold. May contain traces of nuts."
		},
		['en:salt', 'en:spice']
	],
	[
		...
		['en:sugar', 'en:soya-lecithin', 'en:salt']
	],
