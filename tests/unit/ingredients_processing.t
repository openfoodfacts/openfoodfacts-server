    ...
    [
        {
            lc               => "en",
            ingredients_text =>
              "raw milk, sliced tomatoes, garlic powder, powdered eggplant,
    ...
    [
        {
            lc               => "en",
            ingredients_text =>
              "sweetened milk, unsweetened tomatoes, sugared ham"
        },
        [
            {
                'id'         => 'en:milk',
    ...
    [
        {
            lc               => "es",
            ingredients_text =>
"tomate endulzado, berenjena endulzada, calabacín endulzados, jamón endulzadas"
        },
        [
            {
                'id'         => 'en:tomato',
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "bourbon-vanillepulver, Sauerkrautpulver, acerola-pulver"
        },
        [
            {
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
"Schalotte gegart, gegarte haselnüsse, gegarter mandeln, gegartes passionsfrucht,
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalotte geschält, geschälte haselnüsse, geschälter mandeln,
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalotte halbiert, halbierte haselnüsse, halbe mandeln"
        },
        [
            {
                'id'         => 'en:shallot',
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalotte gemahlen, gemahlene mandeln, gemahlener zwiebel,
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalotte getrocknet, getrocknete mandeln, getrockneter zwiebel,
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "hartkäse gesalzen, haselnüsse gesalzene, haselnüsse gesalzenes,
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalotte rehydriert, zwiebel rehydrierte, spinat rehydriertes"
        },
        [
            {
                'id'         => 'en:shallot',
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalotte mariniert, zwiebel marinierte, spinat marinierter,
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalottepüree, zwiebel püree, spinat-püree, selleriemark"
        },
        [
            {
                'id'         => 'en:shallot',
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalotte gerieben, geriebener zwiebel, geriebene spinat"
        },
        [
            {
                'id'         => 'en:shallot',
    ...
    [
        {
            lc               => "de",
            ingredients_text =>
              "Schalottewürfel, spinat gewürfelt, gewürfelte sellerie,
    ...
    [
        {
            lc               => "fr",
            ingredients_text =>
"sel marin fumé, jambon fumé, arôme de fumée, lardons fumés au bois de hêtre "
        },
        [
            {
                'id'         => 'en:sea-salt',
