...
is($product_ref->{categories},
	"Alimentos y bebidas de origen vegetal, Alimentos de origen vegetal, Comida y bebida a base de frutas, Frutas y verduras y sus productos, Comida a base de frutas, Frutas, Frutas tropicales, Frutas del bosque, Ciruelas, Manzanas, Plátanos, Frambuesas, Fresas, naranjas, limones"
);
