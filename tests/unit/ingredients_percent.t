...
my @tests = (
	...
	[
			...
			{
				lc => "hr", 
				ingredients_text => "Šećer, suha smokva (46%) (sumporni dioksid), voda, regulator kiselosti: limunska kiselina, zgušnjivač: voćni pektin. Proizvedeno od 80g voća na 100g gotovog proizvoda. Ukupni šećeri 65g na 100g proizvoda. Ukupni šećeri: 60g na 100g gotovog proizvoda. Proizvedeno od 42 g voća na 100 g gotovog proizvoda."
			},
	],
	[
			...
			{
				lc => "da", 
				ingredients_text => "40% solbær, sukker, vand, geleringsmiddel (E440), konserveringsmiddel (E202). Fremstillet af 40 g frugt pr. 100 g."
			},
	],
	[
			...
			{
				lc => "es", 
				ingredients_text => "Tomate* (160g de tomate por cada 100g de producto final), melocotón, azúcar moreno de caña integral, zumo de limon. Elabora con 59 g de fruta por 100 g. Contenido total de azúcares 60 g por 100g."
			},
	],
	[
			...
			{
				lc => "nl", 
				ingredients_text => "perziken (50%), suiker, geleermiddel (citruspectine), citroensap uit concentraat, conserveermiddel (kaliumsorbaat),antioxidant (ascorbinezuur), zoetstof (steviolglycosiden). Bereid met 50g vruchten per 100g."
			},
	],
	[
			...
			{
				lc => "sv", 
				ingredients_text => "Lingon 50%*, socker*, vatten, förtjockningsmedel (pektin), surhetsreglerande medel (citronsyra). *KRAV-certifierad ekologisk ingrediens. Fruktmängd: 50g per 100g. Total mängd socker är 35 g per 100 g sylt."
			},
	],
);
