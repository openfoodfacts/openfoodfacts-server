...
my @tests = (
	...
	[
		'specific-ingredients-es',
		{
			lc => "es",
			ingredients_text =>
				"Tomate* (160g de tomate por cada 100g de producto final), melocotón, azúcar moreno de caña integral, zumo de limon. Elabora con 59 g de fruta por 100 g. Contenido total de azúcares 60 g por 100g."
		},
	],
	[
	...
	[
		'specific-ingredients-sv',
		{
			lc => "sv",
			ingredients_text =>
				"Lingon 50%*, socker*, vatten, förtjockningsmedel (pektin), surhetsreglerande medel (citronsyra). *KRAV-certifierad ekologisk ingrediens. Fruktmängd: 50g per 100g. Total mängd socker är 35 g per 100 g sylt."
		},
	],
);
