...
is( exists $customized_product_without_components->{components}, F(), "customize_response_for_product excludes components field when not requested" );
...
is( scalar @{ $write_product->{components} }, 3,        "update_product_fields with components_add appends to existing components" );
