...
my @tests = (
	...
	[
		"sv", "Pastöriserad mjölk, salt, syrningskultur, ystenzym.",
...
Saattaa sisältää pieniä määrlä soijaa ja seesaminslemeniä"
	...
	["es", "blabla. INGREDIENTES - AZUCAR - ALMENDRAS", "AZUCAR - ALMENDRAS"],
...
Edit ingredients (en)",
	...
	[
		"fr",
		"INGREDIENTS : badiane* (Illicium verum) 30%, anis vert* (Pimpinella anisum) 30%, fenouil* (Foeniculum vulgare) 30%, racine de réglisse* (Glycyrrhiza glabra). *Produits issus de l'agriculture biologique. INGREDIENTS: star anise* 30%, green anise* 30%, fennel* 30%, liquorice*. *Organically grown products. INGREDIËNTEN: steranijs* 30%, groene anijs* 30%, venkel* 30%, zoethout*. *Biologisch geteelde producten.",
	...
	[
		"de",
		"ZUTATEN: 67% Pizzateig: Weizenmehl, Trinkwasser. ZUTATEN: 33% zubereitete Tomatensosse: 92,7 % Tomatenpüree mit kleinen Tomatenstückchen.",
		"67% Pizzateig: Weizenmehl, Trinkwasser. ZUTATEN: 33% zubereitete Tomatensosse: 92,7 % Tomatenpüree mit kleinen Tomatenstückchen."
	],
...
@tests = (
	...
	["fr", "<STRONG><i>thon</i></STRONG>, eau, sel", "_thon_, eau, sel"],

	["fr", "<b>blé</b>, <i>froment</i>, <strong><u>soja</u></strong>, test", "_blé_, _froment_, _soja_, test"],

	[
		"fr",
		"Traces de <b> fruits à coque </b>, <b></b><b>lait)</b> - extrait de malt d'<u>orge - </u>sel, persil- poivre blanc -ail",
		"Traces de _fruits \x{e0} coque_ , _lait_) - extrait de malt d'_orge_ - sel, persil - poivre blanc - ail"
	],

	["fr", "Farine de<STRONG> <i>blé</i> </STRONG> - sucre", "Farine de _blé_ - sucre"],
	...
	[
		"fr",
		"P&acirc;tes alimentaires cuites aromatis&eacute;es au curcuma",
		"Pâtes alimentaires cuites aromatisées au curcuma"
	],
	...
	[
		"fr",
		"Ingrédients: eau, sel, sucre - Garniture - Ingrédients: Chocolat, sucre",
		"Eau, sel, sucre - Garniture - Ingrédients: Chocolat, sucre"
	],
...
my %regexps = (
	...
	phrases_before_ingredients_list_uppercase => \%ProductOpener::Ingredients::phrases_before_ingredients_list_uppercase,
