...
my @tests = (
	...
	# Test sample import file generated by the server with Description and Example rows
	{
		id => "openfoodfacts_import_template_fr_test",
		excel_file => "openfoodfacts_import_template_fr_test.xlsx",
		columns_fields_json => "openfoodfacts_import_template_fr_test.columns_fields.json",
		default_values => {lc => "fr", countries => "fr"},
	}
);
