...
my $response = $anon_ua->get("http://world.openfoodfacts.localhost/cgi/product.pl?type=edit&code=200000000098");
...
$response = $anon_ua->get("http://world.openfoodfacts.localhost/cgi/product.pl?type=edit&code=200000000099");
