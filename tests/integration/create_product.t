...
my $response = $anon_ua->get("$TEST_WEBSITE_URL/cgi/product.pl?type=edit&code=200000000098");
...
$response = $anon_ua->get("$TEST_WEBSITE_URL/cgi/product.pl?type=edit&code=200000000099");
