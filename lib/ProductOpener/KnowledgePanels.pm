...
sub create_panel_from_json_template ($panel_id, $panel_template, $panel_data_ref, $product_ref, $target_lc, $target_cc, $options_ref) {
...
sub create_ingredients_analysis_panel($product_ref, $target_lc, $target_cc, $options_ref) {
	...
	if (defined $ingredients_analysis_details_data_ref) {
        create_panel_from_json_template("ingredients_analysis_details", "api/knowledge-panels/health/ingredients/ingredients_analysis_details.tt.json",
            $ingredients_analysis_details_data_ref, $product_ref, $target_lc, $target_cc, $options_ref);
