...
'vitamin-pp' => {		
	...
	ro => "Niacină",
	ru => "Ниацин / Витамин PP / Витамин B3",
	sk => "Niacín",
	zh => "维生素 B3 / 维生素 PP（烟酸）",
	zh_CN => "维生素 B3 / 维生素 PP（烟酸）",
	zh_HK => "維他命 B3 / 維生素 PP（菸酸）",
	zh_TW => "維生素 B3 / 維生素 PP（菸酸）",
...
"carbon-footprint" => {
	...
	hu => "Ökológiai lábnyom / CO2 kibocsájtás",
	...
	ru => "Углеродный отпечаток / CO2 эмиссия",
	zh => "碳足迹 / 二氧化碳排放",
	zh_CN => "碳足迹 / 二氧化碳排放",
	zh_HK => "碳足跡 / 二氧化碳排放",
	zh_TW => "碳足跡 / 二氧化碳排放",
...
"collagen-meat-protein-ratio" => {
	...
	zh_TW => "膠原蛋白/肉蛋白比 (最高限度) ",
	zh_HK => "膠原蛋白/肉蛋白比 (最高限度) ",
	zh_CN => "胶原蛋白/肉蛋白比 (最高限度) ",
	zh => "胶原蛋白/肉蛋白比 (最高限度) ",
