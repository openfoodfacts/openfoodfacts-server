...
%Nutriments = (
	...
	"energy-kj" => {
		...
		fr          => "Énergie (kJ)",
		fr_synonyms =>
			[ "valeurs énergétique (kJ)", "valeur énergétique (kJ)" ],
		ga    => "Fuinneamh (kJ)",
	...
	'saturated-fat' => {
		...
		es => "Grasas saturadas",
		es_synonyms =>
			[ "Ácidos grasos saturados", "AGS", "Saturados", "Saturadas" ],
		et => "Küllastunud rasvhapped",
		fi => "Tyydyttyneet rasvat",
		fr => "Acides gras saturés",
		fr_synonyms =>
			[ "Saturés", "AGS", "matières grasses saturées", "MGS" ],
		ga    => "sáSitheáin saill",
		he    => "שומן רווי",
	...
	fiber => {
		...
		fr_synonyms => [
			"fibres",            "fibre",
			"fibre alimentaire", "fibres alimentaires totales"
		],
		ga    => "Snáithín",
		he    => "סיבים תזונתיים",
		hu    => "Rost",
	...
	'vitamin-b9' => {
		...
		fr_synonyms => [
			"Vitamine B9",
			"Acide folique",
			"Acide folique, équivalents alimentaires d'acide folique"
		],
	...
	'biotin' => {
		...
		fr_synonyms => [
			"Biotine", "Vitamine B8", "Vitamine B7", "Vitamine H",
	...
	"fruits-vegetables-nuts" => {
		...
		fi_synonyms =>
			[ "Hedelmät ja kasvikset", "Hedelmät, kasvikset ja pähkinät" ],
		...
		fr_synonyms => [
			...
			"Fruits, légumes, noix",
			"Fruits, légumes, légumineuses, fruits à coques",
			"Fruits et Légumes, légumineuses et fruits à coque"
		],
		es          => "Frutas, verduras y nueces",
		es_synonyms => [
			"Frutas, verduras, nueces",
			"FRUTAS/VERDURAS/NUEZ",
			"FRUTAS, VERDURAS y NUEZ"
		],
	...
	"fruits-vegetables-nuts-estimate" => {
		en =>
			...
			"Hedelmät, kasvikset, pähkinät ja rapsi-, saksanpähkinä- ja oliiviöljyt (arvio ainesosaluettelosta)",
		fr =>
			"Fruits, légumes, noix et huiles de colza, noix et olive (estimation manuelle avec la liste des ingrédients)",
		es =>
			"Frutas, verduras y nueces (estimación de la lista de ingredientes)",
	...
	foreach my $property ("agribalyse_food_code:en", "agribalyse_proxy_food_code:en", "ciqual_food_code:en") {
		...
		if ( defined $product_ref->{categories_properties}{$property} ) {
			push @{ $product_ref->{categories_properties_tags} },
				...
				"no_language",
				$property_name . "-"
					. $product_ref->{categories_properties}{$property}
				);
			push @{ $product_ref->{categories_properties_tags} },
