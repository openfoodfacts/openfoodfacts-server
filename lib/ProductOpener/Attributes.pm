...
sub initialize_attribute ($attribute_id, $target_lc) {
	...
	if ($attribute_id eq "nutriscore") {
		...
		$attribute_ref->{icon_url} = "$static_subdomain/images/attributes/dist/forest-footprint-2026-simple-a.svg";
...
sub compute_attribute_forest_footprint ($product_ref, $target_lc) {
	...
	if ((defined $product_ref->{forest_footprint_2026}) and (defined $product_ref->{forest_footprint_2026}{grade})) {
		...
		if ($grade eq 'unknown') {
			...
			$attribute_ref->{icon_url}
				= "$static_subdomain/images/attributes/dist/forest-footprint-2026-simple-not-computed.svg";
		}
		else {
			...
			$attribute_ref->{icon_url}
				= "$static_subdomain/images/attributes/dist/forest-footprint-2026-simple-$grade.svg";
		}
	}
	else {
