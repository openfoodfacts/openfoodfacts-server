...
my %file_timestamps = (
	"js/dist/display_map.js" => "JS file generated by the 'yarn run build' command",
	"js/dist/display_tag.js" => "JS file generated by the 'yarn run build' command",
	"js/dist/display.js" => "JS file generated by the 'yarn run build' command",
);
...
foreach my $file (sort keys %file_timestamps) {
	...
	if (-e "$www_root/$file") {
		...
		die("File $www_root/$file ($file_timestamps{$file}) does not exist.\n");
	}
}
...
;
	...
	if ((scalar @map_layers) > 0) {
		$header .= <<HTML
	<script src="@{[ format_subdomain('static') ]}/js/dist/display_tag.js?v=$file_timestamps{"js/dist/display_tag.js"}"></script>
HTML
;
...
;
		...
		if ($emb_codes > 0) {
					...
					$header .= <<HTML
	<script src="@{[ format_subdomain('static') ]}/js/dist/display_map.js?v=$file_timestamps{"js/dist/display_map.js"}"></script>
HTML
;
...
<script src="@{[ format_subdomain('static') ]}/js/dist/display.js?v=$file_timestamps{"js/dist/display.js"}" id="mainscript" data-selectcountry="$Lang{select_country}{$lang}"></script>
'use strict';
