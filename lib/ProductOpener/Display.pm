...
JS
	...
	$template_data_ref->{imgid} = $product_ref->{images}{"$template_data_ref->{front_image}{type}_$lc"}{imgid} || $product_ref->{images}{"$template_data_ref->{front_image}{type}_$product_ref->{lc}"}{imgid};
