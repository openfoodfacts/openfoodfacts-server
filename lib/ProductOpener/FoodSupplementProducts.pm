...
C<ProductOpener::FoodSupplementProducts> contains functions specific to food products.

..

=cut

package ProductOpener::FoodSupplementProducts;
...
BEGIN {
	...
	@EXPORT_OK = qw(
		...
		&specific_processes_for_food_supplement_product
