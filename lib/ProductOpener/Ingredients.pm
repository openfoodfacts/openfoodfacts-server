								...
								($pass eq "start_and_end") and (
									...
									(
										...
										(
											...
											or ($ingredients_lc eq
												'lv')    # TODO + match before no space vajpiena (powder-milk)
									...
									or (
										(
											...
											or ($ingredients_lc eq 'da')    # TODO match before or after, no space.
									...
									or (
										(
											...
											or ($ingredients_lc eq
												'hu')    # TODO, + match before without space tejpor (milk-powder)
											or ($ingredients_lc eq 'no')
											or ($ingredients_lc eq 'nn')
											or ($ingredients_lc eq 'sv'
											) # TODO, + match before and after without space skummjölkspulver (skimmed-milk-powder)
										)
