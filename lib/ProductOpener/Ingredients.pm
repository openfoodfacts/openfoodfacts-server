...
my %may_contain_regexps = (
	...
	en =>
		"it may contain traces of|possible traces|traces|may also contain|also may contain|[m|M]ay contain|may be present",
	...
	fr =>
		"peut également contenir|[P|p]eut contenir|qui utilise|utilisant|qui utilise aussi|qui manipule|manipulisant|qui manipule aussi|traces possibles|traces d'allergènes potentielles|trace possible|traces potentielles|trace potentielle|traces éventuelles|traces eventuelles|trace éventuelle|trace eventuelle|traces|trace|Traces éventuelles de",
	hr =>
