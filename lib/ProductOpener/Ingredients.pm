...
my %phrases_after_ingredients_list = (
	...
	fr => [
		...
		'(les )?allerg[eèé]nes(:)?\s+.*(gras|majuscules)',
		...
		'(fabriqu[eé]|transform[eé]|conditionn[eé]|produit) dans un(e)? (atelier|usine) (qui utilise|utilisant|manipulant|qui manipule)',
		'garder dans un endroit frais et sec',
		'information nutritionnelle',
		'ingr[eé]dient(s)? (biologique(s)? )?issu(s)? du commerce [eé]quitable',
		'((\d+)(\s?)kJ\s+)?(\d+)(\s?)kcal',
		...
		'pensez au tri',
		'(il )?peu(t|x) (aussi |également )?contenir',
		'pour en savoir plus',
		'pr(e|é)paration au four',
		'Prépar(e|é)e? avec',
		'pr[eé]sence (possible|éventuelle|eventuelle)',
		'(produit )?(a|à) protéger de ',    # humidité, chaleur, lumière etc.
		'(produit )?conditionn(e|é) sous atmosph(e|è)re protectrice',
		'traces? (possibles?|éventuelles?|eventuelles?|potentielles?)',
		'traces de',
		'traces d\'\w+',
