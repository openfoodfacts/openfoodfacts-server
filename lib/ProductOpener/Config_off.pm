...
@edit_rules = (
	...
	# see https://github.com/openfoodfacts/contributor-quality-issues/issues/18
	{
		...
		actions => [
			["ignore_nutriment_energy-kj"],
			["ignore_nutriment_energy-kcal"],
			["ignore_nutriment_fat"],
			["ignore_nutriment_saturated-fat"],
			["ignore_nutriment_trans-fat"],
			["ignore_nutriment_monounsaturated-fat"],
			["ignore_nutriment_polyunsaturated-fat"],
			["ignore_nutriment_cholesterol"],
			["ignore_nutriment_carbohydrates"],
			["ignore_nutriment_carbohydrates-total"],
			["ignore_nutriment_sugars"],
			["ignore_nutriment_added_sugars"],
			["ignore_nutriment_fiber"],
			["ignore_nutriment_proteins"],
			["ignore_nutriment_salt"],
			["ignore_nutriment_sodium"],
			["ignore_nutriment_alcohol"],
			["ignore_nutriment_vitamin-d"],
			["ignore_nutriment_calcium"],
			["ignore_nutriment_potassium"],
			["ignore_nutriment_energy-kj_100g"],
			["ignore_nutriment_energy-kcal_100g"],
			["ignore_nutriment_fat"],
			["ignore_nutriment_saturated-fat_100g"],
			["ignore_nutriment_trans-fat_100g"],
			["ignore_nutriment_monounsaturated-fat_100g"],
			["ignore_nutriment_polyunsaturated-fat_100g"],
			["ignore_nutriment_cholesterol_100g"],
			["ignore_nutriment_carbohydrates_100g"],
			["ignore_nutriment_carbohydrates-total_100g"],
			["ignore_nutriment_sugars"],
			["ignore_nutriment_added_sugars_100g"],
			["ignore_nutriment_fiber"],
			["ignore_nutriment_proteins"],
			["ignore_nutriment_salt"],
			["ignore_nutriment_sodium"],
			["ignore_nutriment_alcohol"],
			["ignore_nutriment_vitamin-d_100g"],
			["ignore_nutriment_calcium"],
			["ignore_nutriment_potassium_100g"],
			["ignore_serving_size"]
